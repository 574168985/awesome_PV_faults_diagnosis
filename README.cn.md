...
- [期刊|IEEE Journal of Photovoltaics，中科院3区] [图像类型|电致发光] [图像的收集方法|激光线扫描] [图像的处理方法|图像堆栈->分类为背景、电致发光或激光像素->重建无接触传统电致发光,强调缺陷电致发光->校准] [故障类型及严重程度|?] [所应用的层次|光伏阵列] [?] [?] [准确率|?] [Reconstruction and Calibration of Contactless Electroluminescence Images From Laser Line Scanning of Photovoltaic Modules](https://ieeexplore.ieee.org/abstract/document/9736329) **[报告|?]**
